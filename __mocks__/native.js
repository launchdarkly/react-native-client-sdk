const mockNativeModule = {
  ...
  intVariation: jest.fn(),
  intVariationDefaultValue: jest.fn(),
  floatVariation: jest.fn(),
  floatVariationDefaultValue: jest.fn(),
  ...
  intVariationDetail: jest.fn(),
  intVariationDetailDefaultValue: jest.fn(),
  floatVariationDetail: jest.fn(),
  floatVariationDetailDefaultValue: jest.fn(),
